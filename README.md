...
The are some additional conventions that are detailed in [ansible-playbooks.md](ansible-playbooks.md) that determine how to code them to be executed in live or snapshoot mode.
