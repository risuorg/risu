...
# encoding: utf-8
#
# Description: Extension for processing tripleo-common-healtcheck playbooks
...
extension = "tripleo-common-healtcheck"
...
def init():
    ...
    """
    triggers = ['tripleo-common-healtcheck']
    return triggers
...
def listplugins(options=None):
    ...
    yield citellus.findplugins(folders=[pluginsdir], executables=False, extension='tripleo-common-healthcheck', prio=prio)
