...
# description: Director might break Swift cluster when replacing/adding new nodes.
...
exitoutdated(){
    echo $"outdated openstack-tripleo-heat-templates might break Swift cluster when replacing / adding new nodes" >&2
}
