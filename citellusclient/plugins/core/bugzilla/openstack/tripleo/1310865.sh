...
if [[ "${RELEASE}" -eq "7" ]]; then
    ...
    exitoutdated
    # openstack-tripleo-heat-templates needs to be ? or later
    ...
    is_required_rpm_over openstack-tripleo-heat-templates openstack-tripleo-heat-templates-5.4.1-6.el7ost
