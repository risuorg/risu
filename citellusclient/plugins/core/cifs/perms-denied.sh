...
# long_name: Finds matches of kernel.*cifs_mount failed w/return code = -13
# description: Finds matches of error kernel.*cifs_mount failed w/return code = -13

REGEXP="kernel.*cifs_mount failed w/return code = -13"
