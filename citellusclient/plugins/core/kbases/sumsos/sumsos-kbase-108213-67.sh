#!/bin/bash
    ...
    # long_name: Finds matches of qdiskd.*: Error writing node ID block .*
    # description: Finds matches of error qdiskd.*: Error writing node ID block .*

    REGEXP="qdiskd.*: Error writing node ID block .*"
    KCS=108213
