...
# long_name: Finds matches of qdiskd.*: Error writing to quorum disk
# description: Finds matches of error qdiskd.*: Error writing to quorum disk

REGEXP="qdiskd.*: Error writing to quorum disk"
KCS=108213
