...
# long_name: Finds matches of kernel: BFA.*\) lost fabric connectivity.
# description: Finds matches of error kernel: BFA.*\) lost fabric connectivity.

REGEXP="kernel: BFA.*\) lost fabric connectivity."
KCS=118393
