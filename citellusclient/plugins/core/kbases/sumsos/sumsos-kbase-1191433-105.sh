#!/bin/bash
    ...
    # long_name: Finds matches of kernel: end_request: I/O error, dev .*, sector .*
    # description: Finds matches of error kernel: end_request: I/O error, dev .*, sector .*

    REGEXP="kernel: end_request: I/O error, dev .*, sector .*"
    KCS=1191433
