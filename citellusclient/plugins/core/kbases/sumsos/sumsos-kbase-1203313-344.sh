...
# long_name: Finds matches of kernel: sd .*: SCSI error: return code = 0x070d0000
# description: Finds matches of error kernel: sd .*: SCSI error: return code = 0x070d0000

REGEXP="kernel: sd .*: SCSI error: return code = 0x070d0000"
KCS=1203313
