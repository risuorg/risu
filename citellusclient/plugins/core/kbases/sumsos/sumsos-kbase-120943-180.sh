...
# long_name: Finds matches of kernel: Error:Mpx:Bus .* to .* port .* is dead
# description: Finds matches of error kernel: Error:Mpx:Bus .* to .* port .* is dead

REGEXP="kernel: Error:Mpx:Bus .* to .* port .* is dead"
KCS=120943
