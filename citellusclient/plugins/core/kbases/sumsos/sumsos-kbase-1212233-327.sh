...
# long_name: Finds matches of kernel: sd .*: Unhandled error code
# description: Finds matches of error kernel: sd .*: Unhandled error code

REGEXP="kernel: sd .*: Unhandled error code"
KCS=1212233
