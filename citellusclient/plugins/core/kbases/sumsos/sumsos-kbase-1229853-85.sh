#!/bin/bash
    ...
    # long_name: Finds matches of kernel: be2net .*: Error detected in the adapter
    # description: Finds matches of error kernel: be2net .*: Error detected in the adapter

    REGEXP="kernel: be2net .*: Error detected in the adapter"
    KCS=1229853
