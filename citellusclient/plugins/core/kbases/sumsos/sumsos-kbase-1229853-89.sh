...
# long_name: Finds matches of kernel: be2net .*: UE HIGH: .*bit set
# description: Finds matches of error kernel: be2net .*: UE HIGH: .*bit set

REGEXP="kernel: be2net .*: UE HIGH: .*bit set"
KCS=1229853
