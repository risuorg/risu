#!/bin/bash
    ...
    # long_name: Finds matches of kernel: ses .*: \[storvsc\] Sense Key : Illegal Request .*
    # description: Finds matches of error kernel: ses .*: \[storvsc\] Sense Key : Illegal Request .*

    REGEXP="kernel: ses .*: \[storvsc\] Sense Key : Illegal Request .*"
    KCS=1256863
