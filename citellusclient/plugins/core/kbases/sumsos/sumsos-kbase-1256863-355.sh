#!/bin/bash
    ...
    # long_name: Finds matches of kernel: sd .* Sense Key : Illegal Request \[current\]
    # description: Finds matches of error kernel: sd .* Sense Key : Illegal Request \[current\]

    REGEXP="kernel: sd .* Sense Key : Illegal Request \[current\]"
    KCS=1256863
