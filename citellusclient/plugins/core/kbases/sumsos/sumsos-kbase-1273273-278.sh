...
# long_name: Finds matches of kernel: qla2xxx .*-8802:.*: Aborting from RISC nexus=.* sp=.* cmd=.*
# description: Finds matches of error kernel: qla2xxx .*-8802:.*: Aborting from RISC nexus=.* sp=.* cmd=.*
