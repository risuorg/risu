...
# long_name: Finds matches of kernel: st .*: Mode parameters changed
# description: Finds matches of error kernel: st .*: Mode parameters changed

REGEXP="kernel: st .*: Mode parameters changed"
KCS=1290893
