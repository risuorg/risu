#!/bin/bash
    ...
    # long_name: Finds matches of multipathd: .*: hds prio: SCSI error
    # description: Finds matches of error multipathd: .*: hds prio: SCSI error

    REGEXP="multipathd: .*: hds prio: SCSI error"
    KCS=1335913
