...
# long_name: Finds matches of .*gmond.*: slurpfile\(\) read\(\) buffer overflow on file .*
# description: Finds matches of error .*gmond.*: slurpfile\(\) read\(\) buffer overflow on file .*
