#!/bin/bash
    ...
    # long_name: Finds matches of kernel: qla2xxx .*-287d:.*: FCPort state transitioned from LOST to DEAD - portid=.*
    # description: Finds matches of error kernel: qla2xxx .*-287d:.*: FCPort state transitioned from LOST to DEAD - portid=.*
