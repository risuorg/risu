#!/bin/bash
    ...
    # long_name: Finds matches of kernel: BUG: warning at lib/kref.c:32/kref_get()
    # description: Finds matches of error kernel: BUG: warning at lib/kref.c:32/kref_get()

    REGEXP="kernel: BUG: warning at lib/kref.c:32/kref_get()"
    KCS=1376723
