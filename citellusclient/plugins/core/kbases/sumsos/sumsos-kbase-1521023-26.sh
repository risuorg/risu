...
# long_name: Finds matches of lvm.*: Insufficient free space: .* extents needed, but only .* available
# description: Finds matches of error lvm.*: Insufficient free space: .* extents needed, but only .* available
