...
# long_name: Finds matches of kernel: sd .* Write cache: disabled, read cache: enabled, doesn't support DPO or FUA
# description: Finds matches of error kernel: sd .* Write cache: disabled, read cache: enabled, doesn't support DPO or FUA
