...
# long_name: Finds matches of kernel: end_request: critical space allocation error, dev .*, sector .*
# description: Finds matches of error kernel: end_request: critical space allocation error, dev .*, sector .*
