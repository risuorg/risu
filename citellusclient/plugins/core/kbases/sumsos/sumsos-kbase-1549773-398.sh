...
# long_name: Finds matches of kernel: sd .*: .*Sense Key : Data Protect \[current\]
# description: Finds matches of error kernel: sd .*: .*Sense Key : Data Protect \[current\]

REGEXP="kernel: sd .*: .*Sense Key : Data Protect \[current\]"
KCS=1549773
