...
# long_name: Finds matches of kernel: VxVM vxdmp V-.*-.*-.* memory allocation failed for size =0x.*
# description: Finds matches of error kernel: VxVM vxdmp V-.*-.*-.* memory allocation failed for size =0x.*
