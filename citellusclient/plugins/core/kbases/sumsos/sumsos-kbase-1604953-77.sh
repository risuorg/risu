...
# long_name: Finds matches of systemd-udevd: timeout: killing .*
# description: Finds matches of error systemd-udevd: timeout: killing .*

REGEXP="systemd-udevd: timeout: killing .*"
KCS=1604953
