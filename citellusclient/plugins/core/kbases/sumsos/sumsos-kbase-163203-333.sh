#!/bin/bash
    ...
    # long_name: Finds matches of kernel: sd .*: SCSI error: return code = 0x00010000
    # description: Finds matches of error kernel: sd .*: SCSI error: return code = 0x00010000

    REGEXP="kernel: sd .*: SCSI error: return code = 0x00010000"
    KCS=163203
