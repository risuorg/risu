...
# long_name: Finds matches of kernel: sd .*: .*FAILED Result: hostbyte=DID_NO_CONNECT driverbyte=DRIVER_OK
# description: Finds matches of error kernel: sd .*: .*FAILED Result: hostbyte=DID_NO_CONNECT driverbyte=DRIVER_OK
