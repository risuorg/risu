...
# long_name: Finds matches of systemd: Timed out waiting for device .*
# description: Finds matches of error systemd: Timed out waiting for device .*

REGEXP="systemd: Timed out waiting for device .*"
KCS=1751483
