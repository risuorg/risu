...
# long_name: Finds matches of kernel: .*: cdrom_decode_status: status=0x51 { DriveReady SeekComplete Error }
# description: Finds matches of error kernel: .*: cdrom_decode_status: status=0x51 { DriveReady SeekComplete Error }
