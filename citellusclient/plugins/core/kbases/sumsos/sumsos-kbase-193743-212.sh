...
# long_name: Finds matches of kernel: mpdt .*: attempting task abort! scmd\(.*\)
# description: Finds matches of error kernel: mpdt .*: attempting task abort! scmd\(.*\)

REGEXP="kernel: mpdt .*: attempting task abort! scmd\(.*\)"
KCS=193743
