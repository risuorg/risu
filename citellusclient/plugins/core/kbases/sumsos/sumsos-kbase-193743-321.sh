...
# long_name: Finds matches of kernel: scsi .*: task abort: FAILED scmd\(.*\)
# description: Finds matches of error kernel: scsi .*: task abort: FAILED scmd\(.*\)

REGEXP="kernel: scsi .*: task abort: FAILED scmd\(.*\)"
KCS=193743
