...
# long_name: Finds matches of kernel: sd .*: task abort: FAILED scmd\(.*\)
# description: Finds matches of error kernel: sd .*: task abort: FAILED scmd\(.*\)

REGEXP="kernel: sd .*: task abort: FAILED scmd\(.*\)"
KCS=193743
