#!/bin/bash
    ...
    # long_name: Finds matches of kernel: mpt2sas0: fault_state\(0x.*\)
    # description: Finds matches of error kernel: mpt2sas0: fault_state\(0x.*\)

    REGEXP="kernel: mpt2sas0: fault_state\(0x.*\)"
    KCS=1990653
