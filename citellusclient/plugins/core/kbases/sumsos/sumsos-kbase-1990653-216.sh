...
# long_name: Finds matches of kernel: mpt2sas0: sending diag reset !!
# description: Finds matches of error kernel: mpt2sas0: sending diag reset !!

REGEXP="kernel: mpt2sas0: sending diag reset !!"
KCS=1990653
