#!/bin/bash
    ...
    # long_name: Finds matches of kernel: sd .*: SCSI error: return code = 0x00110018
    # description: Finds matches of error kernel: sd .*: SCSI error: return code = 0x00110018

    REGEXP="kernel: sd .*: SCSI error: return code = 0x00110018"
    KCS=202763
