...
# long_name: Finds matches of systemd-logind: Failed to stat\(\) POSIX shared memory segment .*: Permission denied
# description: Finds matches of error systemd-logind: Failed to stat\(\) POSIX shared memory segment .*: Permission denied
