#!/bin/bash
    ...
    # long_name: Finds matches of udevd.*: worker .* unexpectedly returned with status 0x0100
    # description: Finds matches of error udevd.*: worker .* unexpectedly returned with status 0x0100
