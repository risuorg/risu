...
# long_name: Finds matches of kernel: sd .* SCSI device reset on scsi.*
# description: Finds matches of error kernel: sd .* SCSI device reset on scsi.*

REGEXP="kernel: sd .* SCSI device reset on scsi.*"
KCS=2127091
