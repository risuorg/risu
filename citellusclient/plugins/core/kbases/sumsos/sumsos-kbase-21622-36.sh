...
# long_name: Finds matches of clurgmgrd: .*: <err> HA LVM:  Improper setup detected
# description: Finds matches of error clurgmgrd: .*: <err> HA LVM:  Improper setup detected

REGEXP="clurgmgrd: .*: <err> HA LVM:  Improper setup detected"
KCS=21622
