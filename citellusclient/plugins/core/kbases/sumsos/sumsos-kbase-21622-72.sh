...
# long_name: Finds matches of rgmanager.*: \[lvm\] HA LVM:  Improper setup detected
# description: Finds matches of error rgmanager.*: \[lvm\] HA LVM:  Improper setup detected

REGEXP="rgmanager.*: \[lvm\] HA LVM:  Improper setup detected"
KCS=21622
