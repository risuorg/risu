...
# long_name: Finds matches of rgmanager.*: \[lvm\] * initrd image needs to be newer than lvm.conf
# description: Finds matches of error rgmanager.*: \[lvm\] * initrd image needs to be newer than lvm.conf
