...
# long_name: Finds matches of kernel: lpfc .*: .*:9024 FCP command x(12|a3) failed: x.* SNS .* Data: .*
# description: Finds matches of error kernel: lpfc .*: .*:9024 FCP command x(12|a3) failed: x.* SNS .* Data: .*
