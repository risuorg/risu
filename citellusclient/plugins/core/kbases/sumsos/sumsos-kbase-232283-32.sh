...
# long_name: Finds matches of lvm.*: Unmounting invalid snapshot .* from .*
# description: Finds matches of error lvm.*: Unmounting invalid snapshot .* from .*

REGEXP="lvm.*: Unmounting invalid snapshot .* from .*"
KCS=232283
