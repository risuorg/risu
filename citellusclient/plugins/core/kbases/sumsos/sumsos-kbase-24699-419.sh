...
# long_name: Finds matches of kernel: st: Too many tape devices \(max. 512\)
# description: Finds matches of error kernel: st: Too many tape devices \(max. 512\)

REGEXP="kernel: st: Too many tape devices \(max. 512\)"
KCS=24699
