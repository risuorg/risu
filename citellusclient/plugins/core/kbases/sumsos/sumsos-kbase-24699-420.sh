...
# long_name: Finds matches of kernel: st: Too many tape devices \(max. .*\)
# description: Finds matches of error kernel: st: Too many tape devices \(max. .*\)

REGEXP="kernel: st: Too many tape devices \(max. .*\)"
KCS=24699
