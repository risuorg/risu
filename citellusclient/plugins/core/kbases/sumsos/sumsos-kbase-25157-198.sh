...
# long_name: Finds matches of kernel: IPv4: martian source .* from .*, on dev bond.*
# description: Finds matches of error kernel: IPv4: martian source .* from .*, on dev bond.*

REGEXP="kernel: IPv4: martian source .* from .*, on dev bond.*"
KCS=25157
