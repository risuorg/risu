...
# long_name: Finds matches of kernel: sd .* Test WP failed, assume Write Enabled
# description: Finds matches of error kernel: sd .* Test WP failed, assume Write Enabled
