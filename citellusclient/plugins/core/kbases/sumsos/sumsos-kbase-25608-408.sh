...
# long_name: Finds matches of kernel: sd .* Asking for cache data failed
# description: Finds matches of error kernel: sd .* Asking for cache data failed

REGEXP="kernel: sd .* Asking for cache data failed"
KCS=25608
