...
# long_name: Finds matches of kernel: sd .* task abort on host .*, ff.*
# description: Finds matches of error kernel: sd .* task abort on host .*, ff.*

REGEXP="kernel: sd .* task abort on host .*, ff.*"
KCS=2893401
