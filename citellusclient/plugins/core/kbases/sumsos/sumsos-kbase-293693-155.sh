...
# long_name: Finds matches of kernel: audit: backlog limit exceeded
# description: Finds matches of error kernel: audit: backlog limit exceeded

REGEXP="kernel: audit: backlog limit exceeded"
KCS=293693
