...
# long_name: Finds matches of kernel: be2net .*: Please reboot server to recover
# description: Finds matches of error kernel: be2net .*: Please reboot server to recover
