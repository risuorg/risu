#!/bin/bash
    ...
    # long_name: Finds matches of kernel: blk_cloned_rq_check_limits: over max size limit
    # description: Finds matches of error kernel: blk_cloned_rq_check_limits: over max size limit
