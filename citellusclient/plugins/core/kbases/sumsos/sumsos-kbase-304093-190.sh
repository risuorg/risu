#!/bin/bash
    ...
    # long_name: Finds matches of kernel: hpsa .*: Controller lockup detected: 0x.*
    # description: Finds matches of error kernel: hpsa .*: Controller lockup detected: 0x.*

    REGEXP="kernel: hpsa .*: Controller lockup detected: 0x.*"
    KCS=304093
