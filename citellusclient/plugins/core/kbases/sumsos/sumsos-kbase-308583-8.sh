#!/bin/bash
    ...
    # long_name: Finds matches of corosync.*: cman killed by node .* because we were killed by cman_tool or other application
    # description: Finds matches of error corosync.*: cman killed by node .* because we were killed by cman_tool or other application
