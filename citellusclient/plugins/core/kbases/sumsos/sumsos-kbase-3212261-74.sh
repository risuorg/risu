#!/bin/bash
    ...
    # long_name: Finds matches of systemd.*: Timed out stoppping .*md.*
    # description: Finds matches of error systemd.*: Timed out stoppping .*md.*

    REGEXP="systemd.*: Timed out stoppping .*md.*"
    KCS=3212261
