...
# long_name: Finds matches of kernel: qla2xxx .*-6007:.*: Firmware hung.*
# description: Finds matches of error kernel: qla2xxx .*-6007:.*: Firmware hung.*

REGEXP="kernel: qla2xxx .*-6007:.*: Firmware hung.*"
KCS=3241281
