#!/bin/bash
    ...
    # long_name: Finds matches of multipathd: .*: HDIO_GETGEO failed with 25
    # description: Finds matches of error multipathd: .*: HDIO_GETGEO failed with 25

    REGEXP="multipathd: .*: HDIO_GETGEO failed with 25"
    KCS=3348941
