...
# long_name: Finds matches of kernel: Remounting filesystem read-only
# description: Finds matches of error kernel: Remounting filesystem read-only

REGEXP="kernel: Remounting filesystem read-only"
KCS=35329
