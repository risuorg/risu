...
# long_name: Finds matches of kernel: .*: Current: sense key: Medium Error
# description: Finds matches of error kernel: .*: Current: sense key: Medium Error

REGEXP="kernel: .*: Current: sense key: Medium Error"
KCS=35465
