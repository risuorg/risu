...
# long_name: Finds matches of kernel: sd .*: SCSI error: return code = 0x08000002
# description: Finds matches of error kernel: sd .*: SCSI error: return code = 0x08000002

REGEXP="kernel: sd .*: SCSI error: return code = 0x08000002"
KCS=35465
