...
# long_name: Finds matches of kernel: lpfc .*: .*:0338 IOCB wait timeout error - no wake response Data x.*
# description: Finds matches of error kernel: lpfc .*: .*:0338 IOCB wait timeout error - no wake response Data x.*
