...
# long_name: Finds matches of kernel: lpfc .*: .*:0727 TMF FCP_TARGET_RESET to TGT .* LUN .* failed \(.*\) iocb_flag x.*
# description: Finds matches of error kernel: lpfc .*: .*:0727 TMF FCP_TARGET_RESET to TGT .* LUN .* failed \(.*\) iocb_flag x.*
