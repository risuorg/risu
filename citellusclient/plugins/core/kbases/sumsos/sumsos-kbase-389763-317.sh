...
# long_name: Finds matches of kernel: scsi host.*: hdr status = FCPIO_SGL_INVALID
# description: Finds matches of error kernel: scsi host.*: hdr status = FCPIO_SGL_INVALID
