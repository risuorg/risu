...
# long_name: Finds matches of kernel: sd .*: SCSI error: return code = 0x00070002
# description: Finds matches of error kernel: sd .*: SCSI error: return code = 0x00070002

REGEXP="kernel: sd .*: SCSI error: return code = 0x00070002"
KCS=391023
