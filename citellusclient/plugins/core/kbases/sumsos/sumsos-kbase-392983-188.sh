...
# long_name: Finds matches of kernel: hpsa .*: cmd_alloc returned NULL
# description: Finds matches of error kernel: hpsa .*: cmd_alloc returned NULL

REGEXP="kernel: hpsa .*: cmd_alloc returned NULL"
KCS=392983
