...
# long_name: Finds matches of kernel: lpfc .*: .*:0714 SCSI layer issued Bus Reset
# description: Finds matches of error kernel: lpfc .*: .*:0714 SCSI layer issued Bus Reset

REGEXP="kernel: lpfc .*: .*:0714 SCSI layer issued Bus Reset"
KCS=39590
