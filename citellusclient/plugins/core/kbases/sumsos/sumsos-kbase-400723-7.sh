#!/bin/bash
    ...
    # long_name: Finds matches of corosync.*: .* Marking ringid .* interface .* FAULTY
    # description: Finds matches of error corosync.*: .* Marking ringid .* interface .* FAULTY

    REGEXP="corosync.*: .* Marking ringid .* interface .* FAULTY"
    KCS=400723
