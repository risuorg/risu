...
# long_name: Finds matches of kernel: pci .*: BAR .*: can't assign mem pref \(size 0x.*\)
# description: Finds matches of error kernel: pci .*: BAR .*: can't assign mem pref \(size 0x.*\)

REGEXP="kernel: pci .*: BAR .*: can't assign mem pref \(size 0x.*\)"
KCS=411113
