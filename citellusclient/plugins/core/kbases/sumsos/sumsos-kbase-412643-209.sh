...
# long_name: Finds matches of kernel: megasas: FW in FAULT state!!
# description: Finds matches of error kernel: megasas: FW in FAULT state!!

REGEXP="kernel: megasas: FW in FAULT state!!"
KCS=412643
