#!/bin/bash
    ...
    # long_name: Finds matches of kernel: megaraid_sas: resetting fusion adapter .*
    # description: Finds matches of error kernel: megaraid_sas: resetting fusion adapter .*

    REGEXP="kernel: megaraid_sas: resetting fusion adapter .*"
    KCS=412643
