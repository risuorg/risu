...
# long_name: Finds matches of iscsid: Kernel reported iSCSI connection .*:.* error \(1020 - ISCSI_ERR_TCP_CONN_CLOSE: TCP connection closed\) state \(.*\).*
# description: Finds matches of error iscsid: Kernel reported iSCSI connection .*:.* error \(1020 - ISCSI_ERR_TCP_CONN_CLOSE: TCP connection closed\) state \(.*\).*
