#!/bin/bash
    ...
    # long_name: Finds matches of kernel: eth.*: firmware hang detected
    # description: Finds matches of error kernel: eth.*: firmware hang detected

    REGEXP="kernel: eth.*: firmware hang detected"
    KCS=44475
