#!/bin/bash
    ...
    # long_name: Finds matches of kernel: scsi\(.*\): The edc_status node should no longer be used.
    # description: Finds matches of error kernel: scsi\(.*\): The edc_status node should no longer be used.
