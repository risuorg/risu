...
# long_name: Finds matches of kernel: lpfc .*: .*:2858 FLOGI failure Status:.* TMO:x.*
# description: Finds matches of error kernel: lpfc .*: .*:2858 FLOGI failure Status:.* TMO:x.*

REGEXP="kernel: lpfc .*: .*:2858 FLOGI failure Status:.* TMO:x.*"
KCS=48886
