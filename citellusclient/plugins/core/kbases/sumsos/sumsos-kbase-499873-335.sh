...
# long_name: Finds matches of kernel: sd .*: SCSI error: return code = 0x00040000
# description: Finds matches of error kernel: sd .*: SCSI error: return code = 0x00040000

REGEXP="kernel: sd .*: SCSI error: return code = 0x00040000"
KCS=499873
