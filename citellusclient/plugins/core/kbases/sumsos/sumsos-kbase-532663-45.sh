...
# long_name: Finds matches of XFS: possible memory allocation deadlock in kmem_alloc \(mode:0x.*\)
# description: Finds matches of error XFS: possible memory allocation deadlock in kmem_alloc \(mode:0x.*\)
