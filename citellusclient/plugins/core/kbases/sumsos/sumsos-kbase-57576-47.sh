#!/bin/bash
    ...
    # long_name: Finds matches of multipathd: .*: Too many open files
    # description: Finds matches of error multipathd: .*: Too many open files

    REGEXP="multipathd: .*: Too many open files"
    KCS=57576
