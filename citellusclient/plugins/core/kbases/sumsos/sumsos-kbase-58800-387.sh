#!/bin/bash
    ...
    # long_name: Finds matches of kernel: sd .* Add. Sense: Internal target failure
    # description: Finds matches of error kernel: sd .* Add. Sense: Internal target failure

    REGEXP="kernel: sd .* Add. Sense: Internal target failure"
    KCS=58800
