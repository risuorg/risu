...
# long_name: Finds matches of kernel: sd .* Sense Key : Aborted Command \[current\]
# description: Finds matches of error kernel: sd .* Sense Key : Aborted Command \[current\]

REGEXP="kernel: sd .* Sense Key : Aborted Command \[current\]"
KCS=58800
