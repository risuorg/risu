...
# long_name: Finds matches of kernel: sd .*: SCSI error: return code = 0x00070000
# description: Finds matches of error kernel: sd .*: SCSI error: return code = 0x00070000

REGEXP="kernel: sd .*: SCSI error: return code = 0x00070000"
KCS=59311
