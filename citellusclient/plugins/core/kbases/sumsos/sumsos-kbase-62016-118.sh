...
# long_name: Finds matches of kernel: EXT4-fs \(.*\): Unaligned AIO/DIO on inode .* by .*; performance will be poor.
# description: Finds matches of error kernel: EXT4-fs \(.*\): Unaligned AIO/DIO on inode .* by .*; performance will be poor.
