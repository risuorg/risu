...
# long_name: Finds matches of kernel: lost page write due to I/O error on .*
# description: Finds matches of error kernel: lost page write due to I/O error on .*

REGEXP="kernel: lost page write due to I/O error on .*"
KCS=62032
