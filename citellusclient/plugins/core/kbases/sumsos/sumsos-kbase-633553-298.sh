#!/bin/bash
    ...
    # long_name: Finds matches of kernel: qla2xxx .*: vpd r/w failed.  This is likely a firmware bug on this device.  Contact the card vendor for a firmware update
    # description: Finds matches of error kernel: qla2xxx .*: vpd r/w failed.  This is likely a firmware bug on this device.  Contact the card vendor for a firmware update
