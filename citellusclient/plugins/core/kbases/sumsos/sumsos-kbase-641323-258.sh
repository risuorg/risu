...
# long_name: Finds matches of kernel: .*: page allocation failure. order:2, mode:.* in bnx2x.*
# description: Finds matches of error kernel: .*: page allocation failure. order:2, mode:.* in bnx2x.*
