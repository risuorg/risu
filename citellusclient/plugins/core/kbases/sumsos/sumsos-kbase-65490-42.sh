#!/bin/bash
    ...
    # long_name: Finds matches of MR_MONITOR\[.*\]: <MRMON.*> Controller ID:  .*   Unexpected sense:   PD
    # description: Finds matches of error MR_MONITOR\[.*\]: <MRMON.*> Controller ID:  .*   Unexpected sense:   PD
