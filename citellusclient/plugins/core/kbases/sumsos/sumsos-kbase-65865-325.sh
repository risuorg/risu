...
# long_name: Finds matches of kernel: scsi\(.*\): Discard RND Frame -- .*
# description: Finds matches of error kernel: scsi\(.*\): Discard RND Frame -- .*

REGEXP="kernel: scsi\(.*\): Discard RND Frame -- .*"
KCS=65865
