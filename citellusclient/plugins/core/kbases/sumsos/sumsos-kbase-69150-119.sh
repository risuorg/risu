...
# long_name: Finds matches of kernel: lpfc .*: .* READ_FCF_RECORD Indicates empty FCF table
# description: Finds matches of error kernel: lpfc .*: .* READ_FCF_RECORD Indicates empty FCF table
