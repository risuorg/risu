...
# long_name: Finds matches of kernel: sd .*: .*Result: hostbyte=DID_REQUEUE driverbyte=DRIVER_OK
# description: Finds matches of error kernel: sd .*: .*Result: hostbyte=DID_REQUEUE driverbyte=DRIVER_OK
