...
# long_name: Finds matches of kernel: scsi: On host .* channel .* id .* only .* \(max_scsi_report_luns\) of .* luns reported, try increasing max_scsi_report_luns
# description: Finds matches of error kernel: scsi: On host .* channel .* id .* only .* \(max_scsi_report_luns\) of .* luns reported, try increasing max_scsi_report_luns
