...
# long_name: Finds matches of kernel: device-mapper: multipath: Failing path .*
# description: Finds matches of error kernel: device-mapper: multipath: Failing path .*

REGEXP="kernel: device-mapper: multipath: Failing path .*"
KCS=78813
