#!/bin/bash
    ...
    # long_name: Finds matches of kernel: sr: Sense Key : Medium Error \[deferred\]
    # description: Finds matches of error kernel: sr: Sense Key : Medium Error \[deferred\]

    REGEXP="kernel: sr: Sense Key : Medium Error \[deferred\]"
    KCS=906563
