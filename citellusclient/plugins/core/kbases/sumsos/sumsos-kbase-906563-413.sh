#!/bin/bash
    ...
    # long_name: Finds matches of kernel: sr: Add. Sense: Medium format corrupted
    # description: Finds matches of error kernel: sr: Add. Sense: Medium format corrupted

    REGEXP="kernel: sr: Add. Sense: Medium format corrupted"
    KCS=906563
