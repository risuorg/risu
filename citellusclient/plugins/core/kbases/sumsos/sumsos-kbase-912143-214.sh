...
# long_name: Finds matches of kernel: mptscsih: ioc[0-9]: attempting task abort!
# description: Finds matches of error kernel: mptscsih: ioc[0-9]: attempting task abort!

REGEXP="kernel: mptscsih: ioc[0-9]: attempting task abort!"
KCS=912143
