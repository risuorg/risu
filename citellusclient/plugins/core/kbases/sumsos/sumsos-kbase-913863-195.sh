...
# long_name: Finds matches of kernel: ioapic: probe of .* failed with error -22
# description: Finds matches of error kernel: ioapic: probe of .* failed with error -22

REGEXP="kernel: ioapic: probe of .* failed with error -22"
KCS=913863
