#!/bin/bash
    ...
    # long_name: Finds matches of multipathd: .*: alua not supported
    # description: Finds matches of error multipathd: .*: alua not supported

    REGEXP="multipathd: .*: alua not supported"
    KCS=962403
