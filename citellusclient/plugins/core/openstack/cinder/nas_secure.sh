...
ERRORMSGTRUE=$"Detected nas_secure options that may cause issues"
ERRORMSGAUTO=$"Detected nas_secure options as auto - Check .cinderSecureEnvIndicator files on share root"
ERRORMSGNULL=$"Detected no nas_secure options, means working as auto - Check .cinderSecureEnvIndicator files on share root"
