...
if is_lineinfile "DestinationDiskExists: The supplied disk path .* already exists, it is expected not to exist." "${CITELLUS_ROOT}/var/log/nova/nova-compute.log"; then
