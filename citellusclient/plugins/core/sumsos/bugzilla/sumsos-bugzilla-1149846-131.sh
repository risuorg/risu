...
# long_name: Finds matches of kernel: lpfc .*: .*:0372 iotag x.* is out off range: max iotag \(x9c0\)
# description: Finds matches of error kernel: lpfc .*: .*:0372 iotag x.* is out off range: max iotag \(x9c0\)

# bugzilla: https://bugzilla.redhat.com/show_bug.cgi?id=1149846
