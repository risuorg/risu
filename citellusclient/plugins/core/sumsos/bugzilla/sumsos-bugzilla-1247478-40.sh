...
# long_name: Finds matches of kdumpctl: Starting kdump: \[FAILED\]
# description: Finds matches of error kdumpctl: Starting kdump: \[FAILED\]

# bugzilla: https://bugzilla.redhat.com/show_bug.cgi?id=1247478
