...
# long_name: Finds matches of multipathd: .*: failed to resize map : Invalid argument
# description: Finds matches of error multipathd: .*: failed to resize map : Invalid argument

# bugzilla: https://bugzilla.redhat.com/show_bug.cgi?id=1333492
