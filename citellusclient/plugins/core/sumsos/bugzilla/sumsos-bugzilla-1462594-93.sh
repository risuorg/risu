...
# long_name: Finds matches of kernel: blk_update_request: critical target error, dev .*, sector *
# description: Finds matches of error kernel: blk_update_request: critical target error, dev .*, sector *

# bugzilla: https://bugzilla.redhat.com/show_bug.cgi?id=1462594
