...
# long_name: Finds matches of kernel: bio too big device .* \(.* > .*\)
# description: Finds matches of error kernel: bio too big device .* \(.* > .*\)

# bugzilla: https://bugzilla.redhat.com/show_bug.cgi?id=1557434
