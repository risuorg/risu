...
# long_name: Finds matches of qdiskd.*: Error reading node ID block .*
# description: Finds matches of error qdiskd.*: Error reading node ID block .*

REGEXP="qdiskd.*: Error reading node ID block .*"
KCS=108213
