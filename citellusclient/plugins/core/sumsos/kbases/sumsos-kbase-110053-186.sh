...
# long_name: Finds matches of kernel: do_IRQ: .*..* No irq handler for vector \(irq -1\)
# description: Finds matches of error kernel: do_IRQ: .*..* No irq handler for vector \(irq -1\)
