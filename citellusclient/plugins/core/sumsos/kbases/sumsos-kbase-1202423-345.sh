...
# long_name: Finds matches of kernel: sd .*: SCSI error: return code = 0x00020008
# description: Finds matches of error kernel: sd .*: SCSI error: return code = 0x00020008

REGEXP="kernel: sd .*: SCSI error: return code = 0x00020008"
KCS=1202423
