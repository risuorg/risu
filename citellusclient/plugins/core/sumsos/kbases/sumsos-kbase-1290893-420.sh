...
# long_name: Finds matches of kernel: sd .*: Mode parameters changed
# description: Finds matches of error kernel: sd .*: Mode parameters changed

REGEXP="kernel: sd .*: Mode parameters changed"
KCS=1290893
