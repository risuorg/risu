...
# long_name: Finds matches of kernel: .*: sending ioctl 2285 to a partition!
# description: Finds matches of error kernel: .*: sending ioctl 2285 to a partition!

REGEXP="kernel: .*: sending ioctl 2285 to a partition!"
KCS=1326193
