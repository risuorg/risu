...
# long_name: Finds matches of kernel: WARNING: at lib/kref.c:32 kref_get()
# description: Finds matches of error kernel: WARNING: at lib/kref.c:32 kref_get()

REGEXP="kernel: WARNING: at lib/kref.c:32 kref_get()"
KCS=1376723
