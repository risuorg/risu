...
# long_name: Finds matches of kernel: sd .*: emc: ALUA failover mode detected
# description: Finds matches of error kernel: sd .*: emc: ALUA failover mode detected

REGEXP="kernel: sd .*: emc: ALUA failover mode detected"
KCS=139193
