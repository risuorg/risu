...
# long_name: Finds matches of iscsid: Kernel reported iSCSI connection .*:.* error .*
# description: Finds matches of error iscsid: Kernel reported iSCSI connection .*:.* error .*

REGEXP="iscsid: Kernel reported iSCSI connection .*:.* error .*"
KCS=1423383
