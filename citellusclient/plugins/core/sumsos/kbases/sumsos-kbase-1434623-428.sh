...
# long_name: Finds matches of kernel: .*: Current: sense Key : Hardware Error .*
# description: Finds matches of error kernel: .*: Current: sense Key : Hardware Error .*

REGEXP="kernel: .*: Current: sense Key : Hardware Error .*"
KCS=1434623
