...
# long_name: Finds matches of cmaeventd.*: Physical drive failed: .*
# description: Finds matches of error cmaeventd.*: Physical drive failed: .*

REGEXP="cmaeventd.*: Physical drive failed: .*"
KCS=1496983
