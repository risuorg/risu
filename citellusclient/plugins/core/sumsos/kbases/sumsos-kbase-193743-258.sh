...
# long_name: Finds matches of kernel: ses .*: attempting task abort! scmd\(.*\)
# description: Finds matches of error kernel: ses .*: attempting task abort! scmd\(.*\)

REGEXP="kernel: ses .*: attempting task abort! scmd\(.*\)"
KCS=193743
