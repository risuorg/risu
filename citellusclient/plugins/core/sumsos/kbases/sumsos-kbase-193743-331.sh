...
# long_name: Finds matches of kernel: scsi .*: attempting task abort! scmd\(.*\)
# description: Finds matches of error kernel: scsi .*: attempting task abort! scmd\(.*\)

REGEXP="kernel: scsi .*: attempting task abort! scmd\(.*\)"
KCS=193743
