...
# long_name: Finds matches of kernel: sd .*: attempting task abort! scmd\(.*\)
# description: Finds matches of error kernel: sd .*: attempting task abort! scmd\(.*\)

REGEXP="kernel: sd .*: attempting task abort! scmd\(.*\)"
KCS=193743
