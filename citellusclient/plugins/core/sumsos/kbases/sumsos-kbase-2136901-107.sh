...
# long_name: Finds matches of kernel: device-mapper: thin: .*: reached low water mark for metadata device: sending event.
# description: Finds matches of error kernel: device-mapper: thin: .*: reached low water mark for metadata device: sending event.
