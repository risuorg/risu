...
# long_name: Finds matches of kernel: lpfc .*: .*:9064 BLKGRD: lpfc_scsi_prep_dma_buf_s3: Too many sg segments from dma_map_sg.  Config .*, seg_cnt .*
# description: Finds matches of error kernel: lpfc .*: .*:9064 BLKGRD: lpfc_scsi_prep_dma_buf_s3: Too many sg segments from dma_map_sg.  Config .*, seg_cnt .*
