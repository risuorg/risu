...
# long_name: Finds matches of kernel:.*\[<ffff.*>\] \? fanotify_handle_event+.*
# description: Finds matches of error kernel:.*\[<ffff.*>\] \? fanotify_handle_event+.*

REGEXP="kernel:.*\[<ffff.*>\] \? fanotify_handle_event+.*"
KCS=2838901
