...
# long_name: Finds matches of kernel: sfc .* \(unregistered net_device\): .*
# description: Finds matches of error kernel: sfc .* \(unregistered net_device\): .*

REGEXP="kernel: sfc .* \(unregistered net_device\): .*"
KCS=2912941
