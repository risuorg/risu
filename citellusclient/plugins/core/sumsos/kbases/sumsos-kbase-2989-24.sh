...
# long_name: Finds matches of lvm: Duplicate of PV .* dev /dev/.* exists on unknown device .*
# description: Finds matches of error lvm: Duplicate of PV .* dev /dev/.* exists on unknown device .*
