...
# long_name: Finds matches of kernel: sd .*: .*Add. Sense: Invalid field in cdb
# description: Finds matches of error kernel: sd .*: .*Add. Sense: Invalid field in cdb

REGEXP="kernel: sd .*: .*Add. Sense: Invalid field in cdb"
KCS=2994531
