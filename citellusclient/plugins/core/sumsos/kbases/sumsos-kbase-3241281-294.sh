...
# long_name: Finds matches of kernel: qla2xxx .*-6006:.*: Detect abort.*needed.*
# description: Finds matches of error kernel: qla2xxx .*-6006:.*: Detect abort.*needed.*

REGEXP="kernel: qla2xxx .*-6006:.*: Detect abort.*needed.*"
KCS=3241281
