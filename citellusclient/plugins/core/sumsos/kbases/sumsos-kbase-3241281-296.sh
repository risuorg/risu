...
# long_name: Finds matches of kernel: qla2xxx .*-009b:.*: Device state is 0x4 = Need Reset.
# description: Finds matches of error kernel: qla2xxx .*-009b:.*: Device state is 0x4 = Need Reset.
