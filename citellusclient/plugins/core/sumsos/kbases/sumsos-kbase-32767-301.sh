...
# long_name: Finds matches of kernel: qla2xxx .*: Cable is unplugged
# description: Finds matches of error kernel: qla2xxx .*: Cable is unplugged

REGEXP="kernel: qla2xxx .*: Cable is unplugged"
KCS=32767
