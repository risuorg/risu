...
# long_name: Finds matches of kernel: device-mapper: table: device .* too small for target
# description: Finds matches of error kernel: device-mapper: table: device .* too small for target
