...
# long_name: Finds matches of kernel: qla2xxx .*-.*: Unable to read SFP data
# description: Finds matches of error kernel: qla2xxx .*-.*: Unable to read SFP data

REGEXP="kernel: qla2xxx .*-.*: Unable to read SFP data"
KCS=41042
