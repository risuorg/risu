...
# long_name: Finds matches of multipathd: overflow in attribute .*
# description: Finds matches of error multipathd: overflow in attribute .*

REGEXP="multipathd: overflow in attribute .*"
KCS=426693
