...
# long_name: Finds matches of kernel: sd .* Assuming drive cache: write through
# description: Finds matches of error kernel: sd .* Assuming drive cache: write through

REGEXP="kernel: sd .* Assuming drive cache: write through"
KCS=42752
