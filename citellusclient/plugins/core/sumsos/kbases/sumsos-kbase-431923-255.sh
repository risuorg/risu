...
# long_name: Finds matches of kernel: .*: Current: sense key: Not Ready
# description: Finds matches of error kernel: .*: Current: sense key: Not Ready

REGEXP="kernel: .*: Current: sense key: Not Ready"
KCS=431923
