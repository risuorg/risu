...
# long_name: Finds matches of kernel: .*: detected capacity change from .*
# description: Finds matches of error kernel: .*: detected capacity change from .*

REGEXP="kernel: .*: detected capacity change from .*"
KCS=436173
