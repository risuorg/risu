...
# long_name: Finds matches of kernel: qla2xxx .*: LIP reset occurred \(.*\)
# description: Finds matches of error kernel: qla2xxx .*: LIP reset occurred \(.*\)

REGEXP="kernel: qla2xxx .*: LIP reset occurred \(.*\)"
KCS=443243
