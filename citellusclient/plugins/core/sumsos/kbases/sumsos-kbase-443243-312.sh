...
# long_name: Finds matches of kernel: qla2xxx .*: LIP occurred \(.*\)
# description: Finds matches of error kernel: qla2xxx .*: LIP occurred \(.*\)

REGEXP="kernel: qla2xxx .*: LIP occurred \(.*\)"
KCS=443243
