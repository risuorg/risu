...
# long_name: Finds matches of kernel: sd .*: rejecting I/O to offline device
# description: Finds matches of error kernel: sd .*: rejecting I/O to offline device

REGEXP="kernel: sd .*: rejecting I/O to offline device"
KCS=44867
