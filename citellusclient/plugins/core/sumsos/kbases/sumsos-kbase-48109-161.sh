...
# long_name: Finds matches of kernel: ACPI Error: SMBus or IPMI write requires Buffer of length .*, found length .* (.*/exfield-286)
# description: Finds matches of error kernel: ACPI Error: SMBus or IPMI write requires Buffer of length .*, found length .* (.*/exfield-286)
