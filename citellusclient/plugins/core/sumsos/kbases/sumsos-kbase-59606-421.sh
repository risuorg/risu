...
# long_name: Finds matches of kernel: sd .* Using 0xffffffff as device size
# description: Finds matches of error kernel: sd .* Using 0xffffffff as device size

REGEXP="kernel: sd .* Using 0xffffffff as device size"
KCS=59606
