...
# long_name: Finds matches of multipathd: .*: remove map (uevent)
# description: Finds matches of error multipathd: .*: remove map (uevent)

REGEXP="multipathd: .*: remove map (uevent)"
KCS=62041
