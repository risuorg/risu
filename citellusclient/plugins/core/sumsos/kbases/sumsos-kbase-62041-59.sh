...
# long_name: Finds matches of multipathd: .*: devmap not registered, can't remove
# description: Finds matches of error multipathd: .*: devmap not registered, can't remove

REGEXP="multipathd: .*: devmap not registered, can't remove"
KCS=62041
