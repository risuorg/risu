...
# long_name: Finds matches of kernel: cciss .*: cciss: c .* has CHECK CONDITION sense key = 0x4
# description: Finds matches of error kernel: cciss .*: cciss: c .* has CHECK CONDITION sense key = 0x4
