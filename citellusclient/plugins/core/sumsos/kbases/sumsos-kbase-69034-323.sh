...
# long_name: Finds matches of kernel: scsi .*: rejecting I/O to dead device
# description: Finds matches of error kernel: scsi .*: rejecting I/O to dead device

REGEXP="kernel: scsi .*: rejecting I/O to dead device"
KCS=69034
