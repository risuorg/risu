...
# long_name: Finds matches of kernel: .*: Current: sense key: Data Protect
# description: Finds matches of error kernel: .*: Current: sense key: Data Protect

REGEXP="kernel: .*: Current: sense key: Data Protect"
KCS=78813
