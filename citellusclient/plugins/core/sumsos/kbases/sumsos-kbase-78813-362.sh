...
# long_name: Finds matches of kernel: sd .*: .*Sense Key : Data Protect
# description: Finds matches of error kernel: sd .*: .*Sense Key : Data Protect

REGEXP="kernel: sd .*: .*Sense Key : Data Protect"
KCS=78813
