...
if [[ "$OS" != "debian" ]]; then
    ...
    echo $"The following installed packages have been deprecated as per release notes at https://www.debian.org/releases/stretch/amd64/release-notes/ch-information.en.html#noteworthy-obsolete-packages:"
    flag=0
