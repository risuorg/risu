...
#is_required_pkg_over freeradius-3.0.5-0
is_required_pkg freeradius
...
# Function removing comments and trimming leading and ending spaces
strip_and_trim() {
    local file="$1"
