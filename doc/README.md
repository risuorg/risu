...
- Test should include a line starting with `# description: `, `# long_name` and optional `# bugzilla` followed with a one line comment which describes plugin information, for example:
    ~~~sh
