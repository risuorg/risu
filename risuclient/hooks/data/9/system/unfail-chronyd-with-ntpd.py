...
def run(data, quiet=False, options=None):  # do not edit this line
    ...
    sourceid = risu.calcid(string="/plugins/core/system/clock-1-ntpd.sh")
    targetid = risu.calcid(string="/plugins/core/system/clock-1-chrony.sh")
...
def help():  # do not edit this line
    ...
    commandtext = _(
        "This hook proceses Risu outputs and unfails Chronyd if NTP is used"
    )
    return commandtext
