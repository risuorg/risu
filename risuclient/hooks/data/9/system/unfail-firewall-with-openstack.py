...
def run(data, quiet=False, options=None):  # do not edit this line
    ...
    sourceid = risu.calcid(string="/plugins/metadata/openstack/system-role.sh")
    targetid = risu.calcid(string="/plugins/core/system/firewall.sh")
...
def help():  # do not edit this line
    ...
    commandtext = _(
        "This hook proceses Risu outputs and unfails firewall if openstack is used"
    )
    return commandtext
