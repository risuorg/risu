...
is_required_file "${RISU_ROOT}/etc/swift/object-expirer.conf"

if [[ "$(iniparser "${RISU_ROOT}/etc/swift/object-expirer.conf" filter:cache memcache_servers)" == "127.0.0.1" ]]; then
